<div class="page-header">
    ...
    <div class="row">
        <div class="col-6">
            <h1 id="tables">All active users</h1>
            <small>Active users will be able to use the full VPN features.</small>
            <p>&nbsp;</p>
        </div>
        <div class="col-6 text-right pt-4">
            <a href="/suspended-users" class="btn btn-outline-primary btn-link text-primary font-weight-bold">Suspended users</a>
        </div>
    </div>
</div>
<table class="table table-hover">
    ...
    foreach($data as $key => $user):
        ...
        if($user->servers->{$sid}->status == 'active'):
            ...
            <tr class="table-light">
                ...
                <?php if($server_count > 1 ): ?>
                    ...
                    <td>
                        <a href="/users-servers?user=<?php echo $key; ?>" class="btn btn-block btn-sm btn-success text-white">View Servers</a>
                    </td>
                <?php else:
                    $credentials = [
                    ...
                    ?>
                    <td><?php echo $server->server_name.'<br />'.$server->server; ?></td>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-sm btn-warning text-white" href="::javascript" name="<?php echo $key;  ?>" value="<?php echo $sid; ?>" onclick="suspendUser(this.name, this.value)">Suspend</button>
                    </td>
                <?php endif; ?>
            </tr>
